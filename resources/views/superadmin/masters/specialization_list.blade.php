    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <!--<a href="{{ route('add.specialization') }}" class="btn btn-primary waves-effect waves-light mt-3 mb-3" >Add Specialization</a>-->
                    ...
                    <table id="datatable" class="table table-striped dt-responsive nowrap"
                        ...
                        <tbody><span hidden>{{ $i=1; }}</span>
                            ...
                            <tr>
                                ...
                                <a title="Edit" href="{{ route('edit.specialization', $p->id)}}" class="btn btn-outline-success btn-sm edit"><i class="fas fa-pencil-alt"></i></a>
                                  <!--<a title="Delete" href="{{ route('delete.specialization', $p->id)}}" onclick="return confirm('Are you sure you want to delete?');" class="btn btn-outline-danger btn-sm deleteAttr"><i class="fas fa-trash-alt"></i></a>  -->
                                </td>
                                <td>
