                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" id="form" action="{{ $url }}" method="POST">
                        ...
                        <div class="row justify-content-center align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="row mb-4">
                                    <label class="col-sm-3 col-form-label" for="name">Insurance Company Name<span style="color: red">*</span></label>
                                    <div class="col-sm-9">
                                       <input type="text" class="form-control" id="name" name="name" placeholder=""
                                        value="@if(isset($insu->insurance_agen)){{$insu->insurance_agen}}@else{{old('name')}}@endif" onkeydown="return /[a-zA-Z .!@#$%^&*()\-_=+[\]{};:'\,<.>/?]/.test(event.key)">
                                        @if ($errors->has('name'))
                        ...
                        <!--<a class="btn btn-primary" href="{{ route('insurance.list') }}" style="margin-left:6px;">Back</a>-->
                    </form>
                </div>
            </div>
            <!-- end card -->
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <!--<a href="{{ route('add.insurance') }}" class="btn btn-primary waves-effect waves-light mt-3 mb-3" >Add Insurance</a>-->
                    ...
                    <table id="datatable" class="table table-striped dt-responsive nowrap"
                        ...
                        <tbody><span hidden>{{ $i=1; }}</span>
                            ...
                            <tr>
                                ...
                                <a title="Edit" href="{{ route('edit.insurance', $p->id)}}" class="btn btn-outline-success btn-sm edit"><i class="fas fa-pencil-alt"></i></a>
                                 {{-- <a title="Delete" href="{{ route('delete.insurance', $p->id)}}" onclick="return confirm('Are you sure you want to delete?');" class="btn btn-outline-danger btn-sm deleteAttr"><i class="fas fa-trash-alt"></i></a>  --}}
                                </td>
