                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" id="form" action="{{ $url }}" method="POST">
                        ...
                        <div class="row justify-content-center align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="row mb-4">
                                    <label class="col-sm-3 col-form-label" for="hname">Hospital Name<span style="color: red">*</span></label>
                                    <div class="col-sm-9">
                                       <input type="text" class="form-control" id="hname" name="hname" placeholder=""
                                        value="@if(isset($hosp->name)){{$hosp->name}}@else{{old('hname')}}@endif" onkeydown="return /[a-z .]/i.test(event.key)">
                                        @if ($errors->has('hname'))
                                        <span class="text-danger">{{ $errors->first('hname') }}</span>
                                    @endif
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="row mb-4">
                                    ...
                                    <input type="text" class="form-control" id="mobile" name="mobile" placeholder=""
                                        value="@if(isset($hosp->mobile)){{$hosp->mobile}}@else{{old('mobile')}}@endif"  maxlength="10" onkeypress="return isNumeric(event)">
                        ...
                        <!--<a class="btn btn-primary" href="{{ route('hospital.list') }}" style="margin-left:6px;">Back</a>-->
                    </form>
                </div>
            </div>
            <!-- end card -->
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <!--<a href="{{ route('add.hospital') }}" class="btn btn-primary waves-effect waves-light mt-3 mb-3" >Add Hospital</a>-->
                    ...
                    <table id="datatable" class="table table-striped dt-responsive nowrap"
                        ...
                        <tbody><span hidden>{{ $i=1; }}</span>
                            ...
                            <tr>
                                ...
                                <a title="Edit" href="{{ route('edit.hospital', $p->id)}}" class="btn btn-outline-success btn-sm edit"><i class="fas fa-pencil-alt"></i></a>
                                 {{-- <a title="Delete" href="{{ route('delete.hospital', $p->id)}}" onclick="return confirm('Are you sure you want to delete?');" class="btn btn-outline-danger btn-sm deleteAttr"><i class="fas fa-trash-alt"></i></a>  --}}
                                </td>
                                <td>
